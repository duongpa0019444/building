                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <div class="text">Phòng học-Sân bóng</div>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="order-tracking.html" class="">
                                                <div class="text">Xếp lịch họcg</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('admin.registerRoom') }}" class="">
                                        <div class="icon"><i class="icon-image"></i></div>
                                        <div class="text">Đăng ký mượn Phòng học-Sân bóng</div>
                                    </a>
                                </li>
                                <li class="menu-item">
